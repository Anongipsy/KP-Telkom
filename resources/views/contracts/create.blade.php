...
@section('page_title')
    <span class="text-slate-900 dark:text-white">Tambah Kontrak Baru</span>
@endsection
...
<div class="space-y-6 max-w-4xl mx-auto" x-data="{ submitting: false }">
    ...
    <div class="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
        ...
        <span>/</span>
        <span class="text-slate-900 dark:text-slate-200 font-semibold">Tambah Kontrak Baru</span>
    </div>
    ...
    <div class="rounded-3xl bg-white dark:bg-gradient-to-r dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-sm dark:shadow-xl">
        <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">
            Tambah Kontrak Kerja B2B
        </h1>
        <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">
            Data akan divalidasi dan disimpan langsung ke Google Spreadsheet sebagai Single Source of Truth.
        </p>
    </div>
    ...
    >
        ...
        <div class="p-6 rounded-3xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-lg space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <x-form-input
                    name="lop"
                    label="Nomor LOP (Unique Identifier)"
                    placeholder="Contoh: LOP-2026-001"
                    hint="Format LOP harus unik untuk Google Sheets"
                    required
                />

                <x-form-input
                    name="id_mytens"
                    label="ID MyTens (Opsional)"
        ...
        <div
            ...
            x-data="{
                revenue: '{{ old('revenue', '') }}',
                billcompNominal: '{{ old('billcomp_nominal', '0') }}',
                billcompPercentage: {{ (int) old('billcomp_percentage', 0) }},
                billcompStatus: '{{ old('billcomp_status', 'NOT_COMPLETE') }}',
        ...
        >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <x-form-select
                    ...
                    value="BERJALAN"
                    hint="Default untuk kontrak baru adalah Kontrak Berjalan"
                />
                ...
                <x-form-input
                    ...
                    hint="Menjadi metrik utama nilai revenue kontrak"
                    required
                    x-model="revenue"
                ...
                <x-form-input
                    name="nilai_bc"
                    label="Nilai BC (Opsional, default: Realisasi Win / Durasi)"
        ...
        <div class="flex items-center justify-between gap-4 p-4 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            >
                ...
                <span x-text="submitting ? 'Menyimpan ke Google Sheets...' : 'Simpan Kontrak'">Simpan Kontrak</span>
            </button>
        </div>
    </form>
</div>
